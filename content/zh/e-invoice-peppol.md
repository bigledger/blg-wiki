...
BigLedger 是马来西亚 Peppol 网络上获认证的 Peppol 接入点（Access Point），并以服务提供商身份
向 OpenPeppol 提交每月的交易统计报告（TSR）与最终用户统计报告（EUSR）。您的 Peppol ID 通过
马来西亚 SMP 注册，MDEC 会在参与者名称与注册号发布至 Peppol Directory 之前进行核实。

本页不声明任何信息安全认证。若招标或审计需要相关证明，请联系您的 BigLedger 对接人，不要引用本
维基页面作为认证依据。
