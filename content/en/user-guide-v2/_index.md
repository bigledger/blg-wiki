...
<div class="bl-grid" id="blCards">
  ...
  <a class="bl-card" data-cat="start" href="/user-guide/getting-started-v2">
    ...
    <p class="bl-card-count">3 guides</p>
  </a>
  ...
  <a class="bl-card" data-cat="all" href="/user-guide/reports-analytics" style="opacity:.72">
    <div class="bl-icon" style="background:#F1F0EC">
      <svg viewBox="0 0 24 24" fill="none" stroke="#888" stroke-width="1.75" stroke-linecap="round" stroke-linejoin="round"><path d="M18 20V10M12 20V4M6 20v-6"/></svg>
    </div>
    <p class="bl-card-name">Reports &amp; analytics</p>
    <p class="bl-card-count"><span class="bl-soon">Coming soon</span></p>
  </a>
...
<div class="bl-paths">
  ...
  <div class="bl-path">
    ...
    <ul class="bl-path-steps">
      ...
      <li><a href="/applets/finance/financial-report-applet">Financial reports</a></li>
    </ul>
  </div>
  <div class="bl-path">
    ...
    <ul class="bl-path-steps">
      ...
      <li><a href="/user-guide/administration/member-class">Access control</a></li>
      <li><a href="/user-guide/administration/group-listing">Group management</a></li>
    </ul>
  </div>
  <div class="bl-path">
