...
- **[Configuration](/modules-v2/manufacturing/configuration/)** — Set up work centers, process routings, and Bill of Materials (BOM) recipes.
- **[Use Cases](/modules-v2/manufacturing/use-cases/)** — Review reference architectures for discrete assembly, process batch manufacturing, and packing operations.
