...
- **[Configuration](/modules-v2/claims/configuration/)** — Set up expense categories, employee grade entitlement caps, and approval matrices.
- **[Use Cases](/modules-v2/claims/use-cases/)** — Review reference architectures for corporate travel, medical benefits, and sales mileage.
