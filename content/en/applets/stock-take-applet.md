...
{{< figure src="/images/stock-take-applet/stock-take-device-form.png" alt="Stock Take Device create and edit form with device identity fields and activation controls." caption="Device Form Page: Add or update device profiles to support controlled session-based counting." >}}
