...
|------|------------|---------|
| **GRN** | Goods Received Note — document confirming physical receipt of goods | GRN-2024-005678 |
...
A: The GRN is typically linked via the Reference field or through the purchase document flow (Purchase Order → GRN → Purchase Invoice). This enables three-way matching for payment verification.
