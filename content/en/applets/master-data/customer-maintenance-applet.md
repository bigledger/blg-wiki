...
- âœ“ **Automated Credit Control** - The system hard-stops new sales orders if a customer exceeds their defined credit limit.
- âœ“ **Multi-Address Architecture** - Store an unlimited number of specialized addresses (Billing, Shipping HQ, Drop-ship locations) under one parent company.
- âœ“ **Automated Payment Terms** - Set terms (e.g., Net 30) once, and the system automatically calculates all future invoice due dates.
