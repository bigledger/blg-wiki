...
Organization
│
├── Period (Daily / Monthly / Yearly) ──→ WHEN
│
├── Dimension (Branch / Team / Product / Document) ──→ WHO / WHAT
│   │
│   └── Figures (Revenue, Quantity, Margin) ──→ HOW MUCH
│
└── Calculation Set & Type ──→ HOW figures are derived
```
