...
Traditional internal requests often happen via email or paper forms, leading to:
...
{{< cards >}}
  {{< card title="Item Catalog" subtitle="Browse and search internal stock items" link="#catalog-browsing" >}}

  {{< card title="Cart Management" subtitle="Review and adjust items before requesting" link="#shopping-cart" >}}

  {{< card title="Approval Routing" subtitle="Integrated workflow for manager sign-off" link="#approval-flow" >}}

  {{< card title="Status Tracking" subtitle="Real-time updates from request to delivery" link="#tracking" >}}
{{< /cards >}}
...
**Q: Can I see what I requested last month?**
A: Yes, all previous requests are stored in the **Order History** tab with their full fulfillment status.

**Q: What happens if an item is out of stock?**
A: The system will show a "Backorder" or "Out of Stock" badge, and you may be prevented from adding it to the cart until the warehouse replenishes.

**Q: Can I cancel a request after submitting?**
A: You can cancel a request as long as it is still in the "Pending Approval" stage. Once approved or dispatched, you must contact the warehouse directly.

**Q: Is there a cost associated with the items?**
A: While no real money changes hands, the system tracks the "Internal Cost" for department-level budget reporting.
