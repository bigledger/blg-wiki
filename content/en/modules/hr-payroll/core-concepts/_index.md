---
aliases:
- /modules-v2/hr-payroll/core-concepts/
title: "Core Concepts"
...
- **[Configuration](/modules/hr-payroll/configuration/)** — Set up employee profiles, shift rosters, and salary schemes.
- **[Use Cases](/modules/hr-payroll/use-cases/)** — Review reference architectures for manufacturing shift rosters, retail hourly staff, and executive payroll.
