---
aliases:
- /modules-v2/purchasing/core-concepts/
title: "Core Concepts"
...
- **[Configuration](/modules/purchasing/configuration/)** — Set up vendor pricebooks, requisition approval hierarchies, and receiving rules.
- **[Use Cases](/modules/purchasing/use-cases/)** — Review reference architectures for raw material procurement, trading stock reordering, and consignment purchases.
