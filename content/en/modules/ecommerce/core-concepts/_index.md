---
aliases:
- /modules-v2/ecommerce/core-concepts/
title: "Core Concepts"
...
- **[Configuration](/modules/ecommerce/configuration/)** — Set up digital storefront themes, payment gateways, and shipping carrier rules.
- **[Use Cases](/modules/ecommerce/use-cases/)** — Review reference architectures for B2C webstores, B2B wholesale portals, and marketplace sync.
