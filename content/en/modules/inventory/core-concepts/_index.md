---
aliases:
- /modules-v2/inventory/core-concepts/
title: "Core Concepts"
...
- **[Configuration](/modules/inventory/configuration/)** — Set up warehouse bin structures, stock movement rules, and GL account mappings.
- **[Use Cases](/modules/inventory/use-cases/)** — Review reference architectures for multi-warehouse distribution, batch tracking, and kitting.
