---
aliases:
- /modules-v2/manufacturing/api-reference/
title: "API Reference"
description: "Where the REST API for Manufacturing data is documented."
weight: 50
...
platform; there is no separate Manufacturing API.
