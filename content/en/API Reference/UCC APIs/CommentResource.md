# CommentResource APIs

## Create
- **HTTP Method:** `POST`
- **Path:** `/core2/alg/cc/comment`
- **Description:** Handles HTTP POST requests for create.
- **Request Body:** `CommentContainer (JSON)`
...
## Get
- **HTTP Method:** `GET`
- **Path:** `/core2/alg/cc/comment/{uuid}`
...
## GetListPagination
- **HTTP Method:** `GET`
- **Path:** `/core2/alg/cc/comments/pagination`
