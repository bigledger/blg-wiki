...
.tl-playlist{background:#f2f6ff;border-radius:12px;overflow:hidden;border:1px solid #d6e4f7}
.tl-pl-head{padding:14px 16px;background:#1a5cbf;color:#fff}
...
<h1 class="tl-hero-title">Getting Started with BigLedger</h1>
<p class="tl-hero-meta">4 Videos</p>
</div>
...
<iframe id="tlIframe" src="https://www.youtube.com/embed/WrFz_4JTC1s?rel=0&modestbranding=1" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
</div>
</div>
<div class="tl-player-info">
<p class="tl-player-title" id="tlTitle">BLG User Registration</p>
<p class="tl-player-desc" id="tlDesc">First step for every new user - create a BigLedger account and set up initial credentials.</p>
...
<p class="tl-pl-head-title">Getting Started</p>
<p class="tl-pl-head-meta">4 videos</p>
</div>
...
<p class="tl-pl-name">BLG User Registration</p>
<p class="tl-pl-dur">15:56</p>
</div>
</div>
...
<div class="tl-pl-text">
<p class="tl-pl-name">EMP User Single Sign-On</p>
<p class="tl-pl-dur">8:20</p>
</div>
</div>
<div class="tl-pl-item" onclick="tlPlay(2)">
<div class="tl-pl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none"/></svg></div>
<div class="tl-pl-text">
<p class="tl-pl-name">Applet Store</p>
<p class="tl-pl-dur">6:31</p>
</div>
</div>
<div class="tl-pl-item" onclick="tlPlay(3)">
<div class="tl-pl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none"/></svg></div>
<div class="tl-pl-text">
<p class="tl-pl-name">Organization Setup</p>
<p class="tl-pl-dur">15:26</p>
</div>
</div>
</div>
...
<script>
var tlVideos=[
{id:"WrFz_4JTC1s",start:0,title:"BLG User Registration",desc:"First step for every new user - create a BigLedger account and set up initial credentials."},
{id:"UHXUj7CT0qA",start:0,title:"EMP User Single Sign-On",desc:"Learn how to log in and switch across different BigLedger applets seamlessly using Single Sign-On."},
{id:"eaxoDeCC7xg",start:0,title:"Applet Store",desc:"Discover, view permissions for, and install the specific applets needed for your company operations."},
{id:"HERZsB0JVfE",start:0,title:"Organization Setup",desc:"Configure your organization settings, basic company profiles, and required metadata."}
];
var tlCur=0;
function tlPlay(i){
tlCur=i;
...
{{< cards >}}
{{< card link="/user-guide/basic-operations/" title="Basic Operations" subtitle="Master everyday tasks — items, documents, and transactions" >}}
{{< card link="/user-guide/daily-tasks/" title="Daily Tasks" subtitle="Purchase orders, sales orders, invoicing, and payments" >}}
{{< card link="/user-guide/administration/" title="Administration" subtitle="Users, permissions, groups, and system settings" >}}
{{< /cards >}}
