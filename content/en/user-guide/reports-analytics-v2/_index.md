...
<h1 class="tl-hero-title">Reports & Analytics</h1>
<p class="tl-hero-meta">6 Videos</p>
</div>
...
<p class="tl-player-title" id="tlTitle">Financial Report Applet Tutorial: Month-End, P&L, Balance Sheet & Comparisons</p>
<p class="tl-player-desc" id="tlDesc">Complete guide to generating financial reports, month-end close procedures, P&L statements, Balance Sheets, and period comparisons.</p>
...
<p class="tl-pl-head-title">Reports & Analytics</p>
<p class="tl-pl-head-meta">6 videos</p>
</div>
...
<p class="tl-pl-name">Financial Report Applet Tutorial: Month-End, P&L, Balance Sheet & Comparisons</p>
<p class="tl-pl-dur">8:55</p>
</div>
</div>
...
<div class="tl-pl-text">
<p class="tl-pl-name">Credit Report Applet Guide | Outstanding, Aging & AP Reports Explained</p>
<p class="tl-pl-dur">9:55</p>
</div>
</div>
<div class="tl-pl-item" onclick="tlPlay(2)">
<div class="tl-pl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none"/></svg></div>
<div class="tl-pl-text">
<p class="tl-pl-name">Debtor Report Applet Guide | Customer Outstanding & Aging Reports</p>
<p class="tl-pl-dur">15:11</p>
</div>
</div>
<div class="tl-pl-item" onclick="tlPlay(3)">
<div class="tl-pl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none"/></svg></div>
<div class="tl-pl-text">
<p class="tl-pl-name">Ledger & Journal Applet Guide | Transactions, Subledger & Error Checking</p>
<p class="tl-pl-dur">13:08</p>
</div>
</div>
<div class="tl-pl-item" onclick="tlPlay(4)">
<div class="tl-pl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none"/></svg></div>
<div class="tl-pl-text">
<p class="tl-pl-name">Statement of Account Applet Guide | SOA Email & Template Setup</p>
<p class="tl-pl-dur">7:49</p>
</div>
</div>
<div class="tl-pl-item" onclick="tlPlay(5)">
<div class="tl-pl-icon"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><circle cx="12" cy="12" r="10"/><path d="M10 8l6 4-6 4V8z" fill="currentColor" stroke="none"/></svg></div>
<div class="tl-pl-text">
<p class="tl-pl-name">Where do settlement reports appear in Bigledger POS Module</p>
<p class="tl-pl-dur">5:14</p>
</div>
</div>
</div>
...
## Master Reports Catalog

BigLedger provides pre-built reports organized by business function to support operational monitoring and financial compliance:

| Category | Report | Applet / Location | Key Decision It Drives |
| :--- | :--- | :--- | :--- |
| **Statutory Financials** | P&L (Income Statement) | [Financial Report Applet](/applets/finance/financial-report-applet/) | Profitability analysis, operating margins, budget variance |
| **Statutory Financials** | Balance Sheet | [Financial Report Applet](/applets/finance/financial-report-applet/) | Financial position, asset & liability tracking, audit tie-out |
| **Statutory Financials** | Trial Balance | [Financial Report Applet](/applets/finance/financial-report-applet/) | Verification that total debits equal total credits before close |
| **Payables & Cashflow** | Creditor Aging (AP) | [Creditor Report Applet](/applets/finance/creditor-report-applet/) | Cash outflow planning, supplier payment prioritization |
| **Receivables & Debtors**| Debtor Aging (AR) | [Debtor Report Applet](/applets/finance/debtor-report-applet/) | Collection pipeline management, chasing overdue accounts |
| **Receivables & Debtors**| Statement of Account (SOA) | [Statement of Account Applet](/applets/finance/statement-of-account-applet/) | Customer reconciliation statements and dispute resolution |
| **Ledger Audit** | GL Account Inquiry | [General Ledger Applet](/applets/finance/general-ledger-applet/) | Subledger drill-down to trace any GL line to source document |
| **Retail & POS** | Cashier Daily Settlement | POS General Applet | Matching cashier shift takings with ledger bank accounts |
