---
date: 2026-09-06
unpublished_from: content/en/developers/api-reference/accounting.md
url: /developers/api-reference/accounting/
tier: 1
mechanism: draft
...
The page text remains in place at `content/en/developers/api-reference/accounting.md` behind `draft: true`, per ADR-0008 — the URL is reserved for the rewrite.
