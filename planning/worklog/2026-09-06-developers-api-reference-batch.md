---
date: 2026-09-06
unpublished_from: content/en/developers/api-reference/batch.md
url: /developers/api-reference/batch/
tier: 1
mechanism: draft
...
The page text remains in place at `content/en/developers/api-reference/batch.md` behind `draft: true`, per ADR-0008 — the URL is reserved for the rewrite.
