---
date: 2026-09-06
unpublished_from: content/en/developers/api-reference/errors.md
url: /developers/api-reference/errors/
tier: 1
mechanism: draft
reason: 'Documents 25 error codes against 479 real ones, none matching.'
evidence:
...
The page text remains in place at `content/en/developers/api-reference/errors.md` behind `draft: true`, per ADR-0008 — the URL is reserved for the rewrite.
