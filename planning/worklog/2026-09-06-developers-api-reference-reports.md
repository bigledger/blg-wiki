---
date: 2026-09-06
unpublished_from: content/en/developers/api-reference/reports.md
url: /developers/api-reference/reports/
tier: 1
mechanism: draft
...
The page text remains in place at `content/en/developers/api-reference/reports.md` behind `draft: true`, per ADR-0008 — the URL is reserved for the rewrite.
