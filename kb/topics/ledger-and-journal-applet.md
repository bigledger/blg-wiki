...
- 2026-09-05 — Issues (anonymised): create button disabled despite complete form (balance/zero) [src:gh:bigledger/blg-sd-steven-tele#481] [src:gh:bigledger/blg-sd-pc-image#1786]; clone/update fails on lines with null amounts [src:gh:bigledger/blg-sd-kenho-auto-parts#947]; forex documents posted twice (source + shadow) [src:gh:bigledger/blg-sd-grex-multimedia#441]; imported journals not in monthly closing [src:gh:bigledger/blg-sd-zonria#252]; "bd/cd" meaning [src:gh:bigledger/blg-sd-berdaya-marketing#334]; sub-ledger listing empty for GL codes with data [src:gh:bigledger/blg-sd-berdaya-marketing#429] [src:gh:bigledger/blg-sd-cse#247]; Update Journal Remarks empty when the journal is missing [src:gh:bigledger/blg-sd-kenho-auto-parts#220].
