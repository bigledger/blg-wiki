...
- 2026-09-05 — Issues (anonymised): auto TEMP→ACTIVE conversion race closed the document when pressing + on Settlement and could create two vouchers in different locations (fixed 2026-08) [src:gh:bigledger/blg-int-general-task#9567] [src:gh:bigledger/customer-repo-c0c34b#1170]; open-balance formula double-counts contra so a fully contra'd voucher still shows a balance [src:gh:bigledger/blg-intranet#5397]; receipt not found in bank recon because settlement method mapped to another cashbook [src:gh:bigledger/customer-repo-df162e#318]; branch dropdown limited by branch-targeted read permission [src:gh:bigledger/customer-repo-c0c34b#822] [src:gh:bigledger/customer-repo-c9d39c#795]; request for Branch Settings distinct from POS General [src:gh:bigledger/blg-intranet#3622]; duplicate running number [src:gh:bigledger/customer-repo-d8a27b#179].
